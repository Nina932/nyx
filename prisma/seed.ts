    ...
    await prisma.jobRole.createMany({
        ...
        data: [
            ...
            },
            {
                ...
                requiredSkills: ['Agile', 'Roadmap Planning', 'User Research', 'Data Analysis'],
            },
            {
                titleEn: 'UI/UX Designer',
                titleKa: 'UI/UX დიზაინერი',
                requiredSkills: ['Figma', 'User Persona', 'Prototyping'],
            },
        ],
    });
        ...
        data: [
            {
                ...
                performanceScore: 98,
                grade: 'A',
                careerGoalsEn: ['Expand to European market'],
                careerGoalsKa: ['ევროპის ბაზარზე გასვლა'],
                performanceData: [
            ...
            },
            {
                ...
                performanceScore: 95,
                grade: 'A',
                careerGoalsEn: ['Implement a new microservices architecture'],
                careerGoalsKa: ['ახალი მიკროსერვისების არქიტექტურის დანერგვა'],
                performanceData: [
            ...
            },
            {
                ...
                performanceScore: 92,
                grade: 'A',
                careerGoalsEn: ['Become a team lead'],
                careerGoalsKa: ['გუნდის ხელმძღვანელობა'],
                performanceData: [
            ...
            },
            {
                ...
                skills: ['Agile', 'Roadmap Planning', 'JIRA', 'User Research'],
                performanceScore: 90,
                grade: 'A',
                careerGoalsEn: ['Lead the entire product division'],
                careerGoalsKa: ['პროდუქტის დივიზიონის ხელმძღვანელობა'],
                performanceData: [
            ...
            },
            {
                ...
                performanceScore: 85,
                grade: 'B',
                careerGoalsEn: ['Learn backend technologies'],
                careerGoalsKa: ['backend ტექნოლოგიების შესწავლა'],
                performanceData: [
