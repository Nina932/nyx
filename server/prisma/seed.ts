...
async function main() {
    ...
    const admin = await prisma.user.upsert({
        ...
        update: {},
        create: {
            id: 'admin-id-001', // Standard string ID for seed
            email: 'admin@nyx.ge',
    ...
    const roles = await Promise.all([
        prisma.jobRole.upsert({
            ...
            create: {
                ...
                requiredSkills: ['React', 'Node.js', 'TypeScript', 'SQL'] as any,
            },
        }),
        prisma.jobRole.upsert({
            where: { id: 2 },
            ...
            create: {
                ...
                requiredSkills: ['Agile', 'Roadmap Planning', 'User Research', 'Data Analysis'] as any,
            },
        }),
        prisma.jobRole.upsert({
            where: { id: 3 },
            ...
            create: {
                ...
                requiredSkills: ['Figma', 'User Persona', 'Prototyping'] as any,
            },
        }),
    ]);
    ...
    const employees = await Promise.all([
        prisma.employee.upsert({
            ...
            create: {
                ...
                skills: ['Leadership', 'Strategy', 'Finance'] as any,
                performanceScore: 98,
                grade: 'A',
                careerGoalsEn: ['Expand to European market'] as any,
                careerGoalsKa: ['ევროპის ბაზარზე გასვლა'] as any,
                performanceData: [
        ...
        prisma.employee.upsert({
            ...
            create: {
                ...
                skills: ['System Architecture', 'AI/ML', 'Team Leadership'] as any,
                performanceScore: 95,
                grade: 'A',
                careerGoalsEn: ['Implement a new microservices architecture'] as any,
                careerGoalsKa: ['ახალი მიკროსერვისების არქიტექტურის დანერგვა'] as any,
                performanceData: [
        ...
        prisma.employee.upsert({
            ...
            create: {
                ...
                skills: ['React', 'Node.js', 'TypeScript', 'DevOps'] as any,
                performanceScore: 92,
                grade: 'A',
                careerGoalsEn: ['Become a team lead'] as any,
                careerGoalsKa: ['გუნდის ხელმძღვანელობა'] as any,
                performanceData: [
        ...
        prisma.employee.upsert({
            ...
            create: {
                ...
                skills: ['Agile', 'Roadmap Planning', 'JIRA', 'User Research'] as any,
                performanceScore: 90,
                grade: 'A',
                careerGoalsEn: ['Lead the entire product division'] as any,
                careerGoalsKa: ['პროდუქტის დივიზიონის ხელმძღვანელობა'] as any,
                performanceData: [
        ...
        prisma.employee.upsert({
            ...
            create: {
                ...
                skills: ['React', 'CSS', 'JavaScript'] as any,
                performanceScore: 85,
                grade: 'B',
                careerGoalsEn: ['Learn backend technologies'] as any,
                careerGoalsKa: ['backend ტექნოლოგიების შესწავლა'] as any,
                performanceData: [
